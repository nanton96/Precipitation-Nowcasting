...
class MilanDataLoader(data.Dataset):
    ...
    def __init__(self,_set='train',toy=False):
        if toy == True:
            DATA_DIR = 'home/s1818503/dissertation/Mobile-Data-Forecasting-With-Spatio-Temporal-Networks/data_toy/'
        else:
            DATA_DIR = '/home/s1818503/dissertation/Mobile-Data-Forecasting-With-Spatio-Temporal-Networks/data/'
        if _set.lower() == 'train':
